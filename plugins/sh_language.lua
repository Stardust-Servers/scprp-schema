...
ix.flag.Add("9", "French", function(client, bGiven)
end)
ix.flag.Add("8", "Arabic", function(client, bGiven)
end)
ix.flag.Add("7", "German", function(client, bGiven)
end)
ix.flag.Add("6", "Spanish", function(client, bGiven)
end)
ix.flag.Add("5", "Italian", function(client, bGiven)
end)
